...
export default{
    data(){
        return{
            ...
            googleClientId: "981882976984-c6f0re8nfjsjgui8nb1l14uh613t3se1.apps.googleusercontent.com",
            googleRedirectUrl: "http://localhost:8080/login/oauth2/code/google",
            // openid는 요청하지 않아도 기본적으로 제공. email과 profile은 요청시 제공.
            googleScope: "openid email profile",
            kakaoUrl: "https://kauth.kakao.com/oauth/authorize",
            kakaoClientId: "939f25f065f8efa488a33aa96d109dce",
            kakaoRedirectUrl: "http://localhost:8080/login/oauth2/code/kakao",
        }
    },
    methods:{
        async memberLogin(){
